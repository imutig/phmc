    ...
    return (
        <>
            <motion.aside
                ...
                className="fixed left-0 top-0 bottom-0 bg-[#0a0a0a] border-r border-[#2a2a2a] flex flex-col z-50"
            >
                {/* Header avec Logo */}
                        ...
                        <AnimatePresence>
                            {!collapsed && (
                                ...
                                >
                                    ...
                                    <kbd className="text-[10px] bg-gray-800 px-1.5 py-0.5 rounded text-gray-500">
                                        Ctrl+K
                                    </kbd>
                                </motion.div>
                            )}
                                ...
                                <li key={item.href}>
                                    <Link href={item.href}>
                                        ...
                                        `}>
                                            ...
                                            {item.roles.includes('direction') && !item.roles.includes('recruiter') && !collapsed && (
                ...
                {/* Profil Utilisateur */}
                {userProfile && (
                    <div className={`px-3 py-3 border-t border-[#2a2a2a] ${collapsed ? 'flex justify-center' : ''}`}>
