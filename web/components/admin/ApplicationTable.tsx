            ...
            <table className="w-full text-left">
                <thead>
                    <tr className="border-b border-[#2a2a2a] bg-[#1a1a1a]">
                        ...
                        <th className="p-4 font-display text-sm text-gray-500 uppercase tracking-wider hidden md:table-cell">Date</th>
                        ...
                        >
                            ...
                            <td className="p-4">
                                <span className={`
                                    ...
                                    ${STATUS_COLORS[app.status]} bg-opacity-10 border border-current bg-transparent
                                `}>
                                    {STATUS_ICONS[app.status]}
                                    {STATUS_LABELS[app.status]}
                                </span>
                            </td>
                            <td className="p-4 text-gray-400 text-sm hidden md:table-cell font-mono">
                            ...
                            <td className="p-4 text-right">
                                <Link
                                    ...
                                    className="
                                        ...
                                        border border-white/10 group-hover:border-emerald-400/50
                                    "
                                >
