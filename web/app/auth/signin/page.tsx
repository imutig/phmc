                    ...
                    <div className="border border-white/10 bg-white/[0.02] p-8 text-center">
                        <div className="flex justify-center mb-6">
                            <div className="p-4 border border-white/10 bg-white/5">
                                <Shield className="w-12 h-12 text-white/50" strokeWidth={1} />
                            </div>
                        </div>

                        <h1 className="font-display text-2xl font-bold uppercase tracking-widest mb-2">Accès Sécurisé</h1>
                        <p className="font-sans text-gray-400 mb-8 text-sm">
                            Connectez-vous avec Discord pour accéder au portail de recrutement.
                        </p>
    ...
    return (
        <Suspense fallback={
            <main className="min-h-screen flex items-center justify-center bg-[#0a0a0a]">
                <div className="text-white font-display">Chargement...</div>
            </main>
        }>
            <SignInContent />
        </Suspense>
